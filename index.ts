...
async function main() {
    ...
    function printStyledTextP(text: string, styleCode:string, colorCode:string, bgColorCode:string) {
    ...
    function printStyledText(text: string, styleCode:string, colorCode:string, bgColorCode:string) {
        console.log(`\x1b[${styleCode};${colorCode};${bgColorCode}m${text}\x1b[0m`);
    }
